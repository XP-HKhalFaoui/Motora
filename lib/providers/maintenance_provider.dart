...
final maintenanceTypesProvider = FutureProvider.family<List<MaintenanceType>,
    String>((ref, vehicleId) async {
  return ref.read(supabaseServiceProvider).fetchMaintenanceTypes(vehicleId);
});

/// Repair/intervention history for a vehicle.
final maintenanceHistoryProvider = FutureProvider.family<
    List<MaintenanceHistory>, String>((ref, vehicleId) async {
...
final predictionsProvider = FutureProvider.family<List<MaintenancePrediction>,
    String>((ref, vehicleId) async {
